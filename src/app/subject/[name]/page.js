...
const lessonsData = {
  ...
  "اللغة الفرنسية": [
    { type: "section", title: "Module 1 : Candide ou l'optimisme (Conte philosophique)" },
    { type: "subsection", title: "Candide ou l'optimisme (Conte philosophique) - Documents" },
    { type: "lesson", title: "Candide ou l'optimisme - La biographie de Voltaire" },
    { type: "lesson", title: "Candide ou l'optimisme - Fiche de lecture" },
    { type: "lesson", title: "Candide ou l'optimisme - Résumé" },
    { type: "lesson", title: "Candide ou l'optimisme - Résumé chapitre par chapitre" },
    { type: "lesson", title: "Candide ou l'optimisme - Les thèmes" },
    { type: "lesson", title: "Candide ou l'optimisme - Etude des personnages" },

    { type: "section", title: "Module 2 : Il était une fois un vieux couple heureux (Roman maghrébin contemporain)" },
    { type: "subsection", title: "Il était une fois un vieux couple heureux (Roman contemporain) - Documents" },
    { type: "lesson", title: "Il était une fois un vieux couple heureux - Biographie de Mohammed Khaïr-Eddine" },
    { type: "lesson", title: "Il était une fois un vieux couple heureux - Fiche de lecture" },
    { type: "lesson", title: "Il était une fois un vieux couple heureux - Résumé" },
    { type: "lesson", title: "Il était une fois un vieux couple heureux - Personnages principaux" },

    { type: "section", title: "Module 3 : Le Père Goriot (Roman réaliste)" },
    { type: "subsection", title: "Le Père Goriot (Roman réaliste) - Documents" },
    { type: "lesson", title: "Le Père Goriot - Biographie de Balzac" },
    { type: "lesson", title: "Le Père Goriot - Fiche de lecture" },
    { type: "lesson", title: "Le Père Goriot - Résumé" },
    { type: "lesson", title: "Le Père Goriot - Personnages principaux" },

    { type: "subsection", title: "Résumés" },
    { type: "lesson", title: "Candide ou l'optimisme - Résumé" },
    { type: "lesson", title: "Il était une fois un vieux couple heureux - Résumé" },
    { type: "lesson", title: "Le Père Goriot - Résumé" },
  ],
